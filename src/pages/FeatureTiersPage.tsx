    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <header className="mb-20 text-center">
          <span className="inline-block px-4 py-1.5 bg-black/5 text-black rounded-full text-[10px] font-bold uppercase tracking-[0.3em] mb-8 border border-black/10">
            DESIGN EXPERIENCE BY OPUL
          </span>
          <h1 className="text-5xl md:text-7xl font-serif font-bold text-black mb-12 leading-[1.1] tracking-tight">
            RugVision™ Access Plans
          </h1>
        </header>

        <div id="pricing-grid" className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            ...
            >
              ...
              <div className="space-y-4">
                {!user ? (
                  ...
                  >
                    {tier.id === 'free' ? 'Start Free' : 'Upgrade to Creator'}
      ...
      <div className="w-full mb-20">
        <div className="bg-white p-12 border-y border-black/10 shadow-sm">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-serif font-bold text-black mb-8">Production Pricing</h2>
            <div className="space-y-6">
              <p className="text-lg text-black/60 leading-relaxed">
                RugVision™ helps you design — final rug pricing depends on:
              </p>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {['Size', 'Material', 'Construction type', 'Complexity'].map((item) => (
                  <li key={item} className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-[#EFBB76]" />
                    <span className="text-sm font-bold uppercase tracking-widest text-black/80">{item}</span>
                  </li>
                ))}
              </ul>
      ...
      <div className="bg-black p-12 text-center space-y-6">
        <div className="max-w-7xl mx-auto">
