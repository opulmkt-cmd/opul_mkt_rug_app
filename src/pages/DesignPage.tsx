...
const PRESET_COLORS = [
  '#E5E7EB', '#1A1A1A', '#FFFFFF', '#E0E0E0', '#8B4513', 
      ...
      <div className="space-y-12">
        ...
        <section className={`bg-black/5 p-8 rounded-3xl border border-black/10 shadow-sm ${isRegenerateMode ? 'opacity-50 pointer-events-none' : ''}`}>
          <label className="flex items-center gap-2 text-xs font-bold tracking-widest uppercase text-black mb-4">
            <Sparkles className="w-4 h-4" /> 1. Describe Your Vision {isRegenerateMode && '(Locked)'}
          </label>
          <textarea
            value={config.prompt}
            onChange={(e) => setConfig({ ...config, prompt: e.target.value })}
            placeholder="Describe your rug — style, colors, materials, size, or any specific patterns you have in mind..."
            className="w-full bg-white border border-black/10 rounded-2xl p-6 text-lg font-medium focus:outline-none focus:ring-4 focus:ring-[#EFBB76]/20 transition-all min-h-[120px] resize-none"
          />
          <p className="mt-4 text-[10px] text-black/40 font-bold uppercase tracking-widest">
            Be descriptive for better results (e.g., "Modern abstract rug with deep blue waves and golden silk accents")
          </p>
        </section>
        ...
        <section className="bg-black/5 p-8 rounded-3xl border border-black/10 shadow-sm flex flex-col">
          <div className="flex items-center justify-between mb-8">
            <label className="flex items-center gap-2 text-xs font-bold tracking-widest uppercase text-black">
              <Palette className="w-4 h-4" /> 2. Choose Color Palette (Up to 20 Colors)
            </label>
        ...
        <section className={`bg-black/5 p-8 rounded-3xl border border-black/10 shadow-sm ${isRegenerateMode ? 'opacity-50 pointer-events-none' : ''}`}>
          <div className="flex items-center justify-between mb-6">
            <div className="space-y-1">
              <label className="flex items-center gap-2 text-xs font-bold tracking-widest uppercase text-black">
                <Ruler className="w-4 h-4" /> 3. Select Size {isRegenerateMode && '(Locked)'}
              </label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <section className="bg-black/5 p-8 rounded-3xl border border-black/10 shadow-sm">
            <label className="flex items-center gap-2 text-xs font-bold tracking-widest uppercase text-black mb-6">
              <Layers className="w-4 h-4" /> 4. Construction Type
            </label>
