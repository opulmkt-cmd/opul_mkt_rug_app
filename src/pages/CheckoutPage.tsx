      ...
      <div className="max-w-7xl mx-auto px-6 py-24 flex flex-col items-center justify-center text-center space-y-8">
        ...
        <div className="max-w-md">
          ...
          <p className="text-black/40 text-lg leading-relaxed">
            ...
            {promoApplied ? ` You've successfully activated your 7-day trial of the Creator tier with 20 design credits.` : (targetTier ? ` Your account has been upgraded to the ${targetTier.name} plan.` : (isCredits ? ` ${creditCount} credits have been added to your account.` : ' Our team will contact you shortly regarding your custom rug.'))}
          </p>
        </div>
        <button 
        ...
        <div className="lg:col-span-2 bg-white p-10 rounded-[3rem] border border-black/10 shadow-2xl">
          {isInIframe && (
            <motion.div 
              ...
              animate={{ opacity: 1, y: 0 }}
              className="mb-8 p-6 bg-blue-50 border border-blue-200 rounded-2xl flex items-center justify-between gap-4"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-sm font-bold text-blue-900">Secure Payment Environment</h4>
                  <p className="text-[10px] text-blue-700 font-medium uppercase tracking-wider">
              ...
              <button 
                ...
                className="px-6 py-2.5 bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest rounded-full hover:bg-blue-700 transition-all shadow-md flex items-center gap-2"
              >
